...
extension View {
    func babyultraCard() -> some View {
        self
            ...
            .clipShape(RoundedRectangle(cornerRadius: BabyUltra.cardRadius))
    }
    ...
    func accentGlow(radius: CGFloat = 8) -> some View {
        self.shadow(color: BabyUltra.accent.opacity(0.45), radius: radius, y: 2)
            .shadow(color: BabyUltra.accentRose.opacity(0.25), radius: radius * 1.5, y: 0)
    }
            ...
            ZStack {
                ...
                LinearGradient(
                    stops: [
                        ...
                        .init(color: BabyUltra.bg.opacity(0.55), location: 0.40),
                        .init(color: BabyUltra.bg, location: 0.50),
                    ],
                    startPoint: .top,
                    endPoint: .bottom
                )
